...
// TODO: figure out if i have to write custom request callback method to get the token from the ajax call and put it in the passwordgrant_modal - i do
     ...
     */
    this.handlePWG = function(data) {
        alert(data.accessToken);


        if (data.accessToken) {  // lol
...
// TODO: figure out if i need this or not.. prob do to generate the token .. must generate into modal token place
    /**
    ...
    this.saveAuthModal = function(e) {
        ...
        if (parentClass.attr('data-role') == 'basic_auth_modal') {
            ...
            // TODO: write function that validates the basic auth fields
            // TODO: write function that 
            var passwordGrantURL = "https://moearthnetworks-test.apigee.net/purina" + "/v1";    // TODO: this must be the url that validates the tokens | this if statement will 
    ...
    this.sendRequest = function() {
        ...
        if (selectedAuthScheme  == "basicauth") { // Add basic details in send request proxy API call.
            ...
            if (localStorage.apisOAuth2CredentialsDetails && apiName==localStorage.apisOAuth2CredentialsDetails.split("@@@")[0]) {
                ...
                // this part makes the requests to the api, each one must be headed with bearererer auth
